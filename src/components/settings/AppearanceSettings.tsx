      ...
      <div className="max-w-md mx-auto bg-white/90 dark:bg-gray-800/90 backdrop-blur-md shadow-2xl min-h-screen relative z-10 border-l border-r border-white/20 dark:border-gray-700/20">
        ...
        <div className="bg-gradient-to-r from-yellow-100/95 via-amber-100/95 to-orange-100/95 dark:from-gray-800/95 dark:via-gray-700/95 dark:to-gray-800/95 backdrop-blur-md border-b border-yellow-200/50 dark:border-gray-600/50 p-4 shadow-lg">
          <div className="flex items-center space-x-3">
            ...
            <h1 className="text-2xl font-heading font-bold bg-gradient-to-r from-yellow-600 via-amber-600 to-orange-600 dark:from-yellow-400 dark:via-amber-400 dark:to-orange-400 bg-clip-text text-transparent">Appearance</h1>
          </div>
        </div>
          ...
          <div className="bg-gradient-to-r from-gray-50/80 to-slate-50/80 dark:from-gray-900/20 dark:to-slate-900/20 backdrop-blur-sm rounded-xl p-4 shadow-lg border border-gray-200/50 dark:border-gray-700/50">
            <div className="flex items-center justify-between">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  <h3 className="font-heading font-bold text-gray-800 dark:text-gray-200">Dark Mode</h3>
                  <p className="text-sm font-body text-gray-600/80 dark:text-gray-400/80">Use dark theme</p>
                </div>
              </div>
              <Switch
                checked={appearance.darkMode}
                onCheckedChange={() => handleToggle('darkMode')}
                className="data-[state=checked]:bg-gradient-to-r data-[state=checked]:from-gray-500 data-[state=checked]:to-slate-500"
              />
            </div>
          </div>
          ...
          <div className="bg-gradient-to-r from-blue-50/80 to-indigo-50/80 dark:from-blue-900/20 dark:to-indigo-900/20 backdrop-blur-sm rounded-xl p-4 shadow-lg border border-blue-200/50 dark:border-blue-700/50">
            <div className="space-y-3">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  <h3 className="font-heading font-bold text-blue-800 dark:text-blue-200">Theme</h3>
                  <p className="text-sm font-body text-blue-600/80 dark:text-blue-400/80">Choose your preferred theme</p>
                </div>
              </div>
              <Select value={appearance.theme} onValueChange={(value) => handleSelect('theme', value)}>
                <SelectTrigger className="bg-white/80 dark:bg-gray-700/80 border-blue-200 dark:border-blue-600">
                  <SelectValue />
                </SelectTrigger>
                <SelectContent>
          ...
          <div className="bg-gradient-to-r from-purple-50/80 to-violet-50/80 dark:from-purple-900/20 dark:to-violet-900/20 backdrop-blur-sm rounded-xl p-4 shadow-lg border border-purple-200/50 dark:border-purple-700/50">
            <div className="space-y-3">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  <h3 className="font-heading font-bold text-purple-800 dark:text-purple-200">Accent Color</h3>
                  <p className="text-sm font-body text-purple-600/80 dark:text-purple-400/80">Choose your accent color</p>
                </div>
              </div>
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center space-x-3">
                <div className="w-10 h-10 bg-gradient-to-br from-green-100 to-emerald-100 dark:from-green-900 dark:to-emerald-900 rounded-full flex items-center justify-center ring-2 ring-green-200 dark:ring-green-600 shadow-lg">
                  <Minimize className="w-5 h-5 text-green-600 dark:text-green-400" />
                </div>
                <div>
                  <h3 className="font-heading font-bold text-green-800 dark:text-green-200">Compact Mode</h3>
                  <p className="text-sm font-body text-green-600/80 dark:text-green-400/80">Use compact layout</p>
                </div>
              </div>
              <Switch
