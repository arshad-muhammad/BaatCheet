      ...
      <div className="max-w-md mx-auto bg-white/90 dark:bg-gray-800/90 backdrop-blur-md shadow-2xl min-h-screen relative z-10 border-l border-r border-white/20 dark:border-gray-700/20">
        ...
        <div className="bg-gradient-to-r from-yellow-100/95 via-amber-100/95 to-orange-100/95 dark:from-gray-800/95 dark:via-gray-700/95 dark:to-gray-800/95 backdrop-blur-md border-b border-yellow-200/50 dark:border-gray-600/50 p-4 shadow-lg">
          <div className="flex items-center space-x-3">
            ...
            <h1 className="text-2xl font-heading font-bold bg-gradient-to-r from-yellow-600 via-amber-600 to-orange-600 dark:from-yellow-400 dark:via-amber-400 dark:to-orange-400 bg-clip-text text-transparent">Notifications</h1>
          </div>
        </div>
          ...
          <div className="bg-gradient-to-r from-blue-50/80 to-indigo-50/80 dark:from-blue-900/20 dark:to-indigo-900/20 backdrop-blur-sm rounded-xl p-4 shadow-lg border border-blue-200/50 dark:border-blue-700/50">
            <div className="flex items-center justify-between">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  <h3 className="font-heading font-bold text-blue-800 dark:text-blue-200">Message Notifications</h3>
                  <p className="text-sm font-body text-blue-600/80 dark:text-blue-400/80">Get notified for new messages</p>
                </div>
              </div>
              <Switch
          ...
          <div className="bg-gradient-to-r from-green-50/80 to-emerald-50/80 dark:from-green-900/20 dark:to-emerald-900/20 backdrop-blur-sm rounded-xl p-4 shadow-lg border border-green-200/50 dark:border-green-700/50">
            <div className="flex items-center justify-between">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  <h3 className="font-heading font-bold text-green-800 dark:text-green-200">Call Notifications</h3>
                  <p className="text-sm font-body text-green-600/80 dark:text-green-400/80">Get notified for incoming calls</p>
                </div>
              </div>
              <Switch
          ...
          <div className="bg-gradient-to-r from-purple-50/80 to-violet-50/80 dark:from-purple-900/20 dark:to-violet-900/20 backdrop-blur-sm rounded-xl p-4 shadow-lg border border-purple-200/50 dark:border-purple-700/50">
            <div className="flex items-center justify-between">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  <h3 className="font-heading font-bold text-purple-800 dark:text-purple-200">Group Notifications</h3>
                  <p className="text-sm font-body text-purple-600/80 dark:text-purple-400/80">Get notified for group messages</p>
                </div>
              </div>
              <Switch
          ...
          <div className="bg-gradient-to-r from-orange-50/80 to-amber-50/80 dark:from-orange-900/20 dark:to-amber-900/20 backdrop-blur-sm rounded-xl p-4 shadow-lg border border-orange-200/50 dark:border-orange-700/50">
            <div className="flex items-center justify-between">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  <h3 className="font-heading font-bold text-orange-800 dark:text-orange-200">Sound</h3>
                  <p className="text-sm font-body text-orange-600/80 dark:text-orange-400/80">Play sound for notifications</p>
                </div>
              </div>
              <Switch
          ...
          <div className="bg-gradient-to-r from-red-50/80 to-pink-50/80 dark:from-red-900/20 dark:to-pink-900/20 backdrop-blur-sm rounded-xl p-4 shadow-lg border border-red-200/50 dark:border-red-700/50">
            <div className="flex items-center justify-between">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  <h3 className="font-heading font-bold text-red-800 dark:text-red-200">Vibration</h3>
                  <p className="text-sm font-body text-red-600/80 dark:text-red-400/80">Vibrate for notifications</p>
                </div>
              </div>
              <Switch
          ...
          <div className="bg-gradient-to-r from-indigo-50/80 to-blue-50/80 dark:from-indigo-900/20 dark:to-blue-900/20 backdrop-blur-sm rounded-xl p-4 shadow-lg border border-indigo-200/50 dark:border-indigo-700/50">
            <div className="flex items-center justify-between">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  <h3 className="font-heading font-bold text-indigo-800 dark:text-indigo-200">Show Preview</h3>
                  <p className="text-sm font-body text-indigo-600/80 dark:text-indigo-400/80">Show message preview in notifications</p>
                </div>
              </div>
              <Switch
